...
// --- STABLE PARTNER MODAL WITH UNIFIED $25/MO ANNUAL & $35/MO MONTHLY PRICING ---
                    ...
                    <form onSubmit={handleFreeSubmit} className="space-y-4">
                      <div className={`p-4 rounded-2xl ${theme.isDark ? 'bg-black/20 border border-white/5' : 'bg-slate-100 border border-slate-200'} space-y-2`}>
                        ...
                        <p className={`text-[11px] ${theme.secondaryText} leading-relaxed`}>
                          Get a verified listing across Ann Arbor in exchange for placing our compact A2 Vibe QR code badge at your host stand, checkout counter, and front window.
                        </p>
                      </div>
                      ...
                      <div>
                        <label className={`text-[10px] font-black uppercase tracking-widest ${theme.secondaryText} block mb-1.5`}>Category / Cuisine</label>
                        <input
                          type="text"
                          required
                          value={cuisine}
                          onChange={(e) => setCuisine(e.target.value)}
                          placeholder="e.g. Marijuana Dispensary, Vinyl Records, Korean Street Food"
                          className={`w-full p-3.5 rounded-2xl ${theme.isDark ? 'bg-black/20 border-white/10 text-white' : 'bg-slate-50 border-slate-200 text-slate-900'} border text-xs font-bold outline-none focus:border-[#ffcb05]`}
                        />
                      </div>
                  ...
                  <div className="p-5 rounded-3xl bg-gradient-to-br from-[#00274c] to-[#0a1b30] border border-[#ffcb05]/30 text-white space-y-3">
                    <div className="flex items-center justify-between">
                      ...
                      <span className="text-[10px] font-bold text-[#38bdf8] flex items-center gap-1">
                        <FileText size={12} /> Menu & Link Upload Enabled
                      </span>
                    </div>

                    <h4 className="text-xl font-header font-black uppercase italic">
                      Boosted Showcase & Retail Profile
                    </h4>

                    <ul className="text-xs text-slate-300 space-y-1.5 pt-1">
                      <li className="flex items-center gap-2">✓ <strong>Up to 20 HD Photos</strong> (Dishes, products, store showroom)</li>
                      <li className="flex items-center gap-2">✓ <strong>Longer Description & Story</strong> with direct ticket or ordering links</li>
                      <li className="flex items-center gap-2">✓ <strong>Menu or Catalog PDF Link</strong> on profile</li>
                  ...
                  <div className="p-4 rounded-2xl bg-gradient-to-r from-[#f97316]/20 via-[#f97316]/10 to-transparent border border-[#f97316]/30 flex items-center justify-between gap-3">
                    <div>
                      <div className="flex items-center gap-1.5">
                        ...
                        <span className={`text-xs font-black uppercase ${theme.isDark ? 'text-white' : 'text-slate-900'}`}>Featured Spotlight Pick</span>
                    ...
                    <div className="grid grid-cols-1 gap-2.5">
                      <div className={`p-3.5 rounded-2xl border ${theme.border} ${theme.isDark ? 'bg-black/10' : 'bg-slate-100'} flex items-center justify-between`}>
                        <div>
                          ...
                          <p className={`text-[10px] ${theme.secondaryText}`}>Permanent published culinary, retail, or brand editorial</p>
                        </div>
                        <button
        ...
        <div className="pt-2">
          <div className="mx-1 p-5 rounded-[32px] bg-gradient-to-r from-[#00274c] via-[#051a34] to-[#0a121e] border border-[#ffcb05]/20 flex items-center justify-between shadow-xl">
            <div className="space-y-1 text-left">
              ...
              <p className="text-[11px] text-slate-300">Feature your eatery, store, or gathering across A2 Vibe.</p>
            </div>
            <button
